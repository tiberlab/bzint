...
PROGRAM test
  ...
  ! define the square
  p1 = point(-1.0D0, -1.0D0)
  p2 = point(1.0D0, -1.0D0)
  p3 = point(1.0D0, 1.0D0)
  p4 = point(-1.0D0, 1.0D0)

  ! the energy values
  erg = (/ 0.0D0, 0.5D0, 0.99D0, 1.0D0, 1.2D0, 2.0D0, 2.5D0 /)


  print *,'1. situation: e = x^2 + y^2, -1 < x,y < 1'
  print *,'-----------------------------------------'
  print *,'Triangulation (A)'
  ! triangulate
  ! 1. triangle
  t(1)%p(1) = point(-1.0D0,-1.0D0)
  t(1)%p(2) = point(0.0D0,-1.0D0)
  t(1)%p(3) = point(0.2D0,0.3D0)
  ! 2. triangle
  t(2)%p(1) = point(0.0D0,-1.0D0)
  t(2)%p(2) = point(1.0D0,-1.0D0)
  t(2)%p(3) = point(0.2D0,0.3D0)
  ! 3. triangle
  t(3)%p(1) = point(1.0D0,-1.0D0)
  t(3)%p(2) = point(1.0D0,0.0D0)
  t(3)%p(3) = point(0.2D0,0.3D0)
  ! 4. triangle
  t(4)%p(1) = point(1.0D0,0.0D0)
  t(4)%p(2) = point(1.0D0,1.0D0)
  t(4)%p(3) = point(0.2D0,0.3D0)
  ! 5. triangle
  t(5)%p(1) = point(1.0D0,1.0D0)
  t(5)%p(2) = point(0.0D0,1.0D0)
  t(5)%p(3) = point(0.2D0,0.3D0)
  ! 6. triangle
  t(6)%p(1) = point(0.0D0,1.0D0)
  t(6)%p(2) = point(-1.0D0,1.0D0)
  t(6)%p(3) = point(0.2D0,0.3D0)
  ! 7. triangle
  t(7)%p(1) = point(-1.0D0,1.0D0)
  t(7)%p(2) = point(-1.0D0,0.0D0)
  t(7)%p(3) = point(0.2D0,0.3D0)
  ! 8. triangle
  t(8)%p(1) = point(-1.0D0,0.0D0)
  t(8)%p(2) = point(-1.0D0,-1.0D0)
  t(8)%p(3) = point(0.2D0,0.3D0)
...
if (.TRUE.) then
  ...
  t(1)%p(1) = point(-1.0D0,-1.0D0)
  t(1)%p(2) = point(0.0D0,-1.0D0)
  t(1)%p(3) = point(-1.0D0,0.0D0)
! 9. triangle
  t(9)%p(1) = point(-0.25D0,-0.75D0)
  t(9)%p(2) = point(0.0D0,0.0D0)
  t(9)%p(3) = point(-1.0D0,0.0D0)
  ! 2. triangle
  t(2)%p(1) = point(0.0D0,-1.0D0)
  t(2)%p(2) = point(0.0D0,0.0D0)
  t(2)%p(3) = point(-0.25D0,-0.75D0)
  ! 3. triangle
  t(3)%p(1) = point(0.0D0,-1.0D0)
  t(3)%p(2) = point(1.0D0,-1.0D0)
  t(3)%p(3) = point(1.0D0,0.0D0)
  ! 4. triangle
  t(4)%p(1) = point(0.0D0,-1.0D0)
  t(4)%p(2) = point(1.0D0,0.0D0)
  t(4)%p(3) = point(0.0D0,0.0D0)
  ! 5. triangle
  t(5)%p(1) = point(1.0D0,0.0D0)
  t(5)%p(2) = point(1.0D0,1.0D0)
  t(5)%p(3) = point(0.0D0,1.0D0)
  ! 6. triangle
  t(6)%p(1) = point(0.0D0,0.0D0)
  t(6)%p(2) = point(1.0D0,0.0D0)
  t(6)%p(3) = point(0.0D0,1.0D0)
  ! 7. triangle
  t(7)%p(1) = point(0.0D0,1.0D0)
  t(7)%p(2) = point(-1.0D0,1.0D0)
  t(7)%p(3) = point(-1.0D0,0.0D0)
  ! 8. triangle
  t(8)%p(1) = point(-1.0D0,0.0D0)
  t(8)%p(2) = point(0.0D0,0.0D0)
  t(8)%p(3) = point(0.0D0,1.0D0)
