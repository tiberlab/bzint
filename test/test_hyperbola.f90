...
PROGRAM test
  ...
  print *,''
  print *,'Test of 2D integration for HYPERBOLA'
  print *,'===================================='
  print *,''
  ...
  ! triangulate
  ! 1. triangle
  t(1)%p1 = point(-1.0D0,-1.0D0)
  t(1)%p2 = point(0.0D0,-1.0D0)
  t(1)%p3 = point(0.2D0,0.3D0)
  ! 2. triangle
  t(2)%p1 = point(0.0D0,-1.0D0)
  t(2)%p2 = point(1.0D0,-1.0D0)
  t(2)%p3 = point(0.2D0,0.3D0)
  ! 3. triangle
  t(3)%p1 = point(1.0D0,-1.0D0)
  t(3)%p2 = point(1.0D0,0.0D0)
  t(3)%p3 = point(0.2D0,0.3D0)
  ! 4. triangle
  t(4)%p1 = point(1.0D0,0.0D0)
  t(4)%p2 = point(1.0D0,1.0D0)
  t(4)%p3 = point(0.2D0,0.3D0)
  ! 5. triangle
  t(5)%p1 = point(1.0D0,1.0D0)
  t(5)%p2 = point(0.0D0,1.0D0)
  t(5)%p3 = point(0.2D0,0.3D0)
  ! 6. triangle
  t(6)%p1 = point(0.0D0,1.0D0)
  t(6)%p2 = point(-1.0D0,1.0D0)
  t(6)%p3 = point(0.2D0,0.3D0)
  ! 7. triangle
  t(7)%p1 = point(-1.0D0,1.0D0)
  t(7)%p2 = point(-1.0D0,0.0D0)
  t(7)%p3 = point(0.2D0,0.3D0)
  ! 8. triangle
  t(8)%p1 = point(-1.0D0,0.0D0)
  t(8)%p2 = point(-1.0D0,-1.0D0)
  t(8)%p3 = point(0.2D0,0.3D0)
